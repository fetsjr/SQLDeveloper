...
namespace SQLDeveloper.Modulos.Comparador
{
    ...
    {
        private List<CLexema> Lexemas1;
        private List<CLexema> Lexemas2;
        private List<CLexema>  SeparaCadena(string cadena )
        {
            //separa la cadena en lexemas y lo almacena en la lista
            CAnaLex analizador = new CAnaLex();
            CLexema obj = null;
            List<CLexema> l = new List<CLexema>();
        ...
        private CSincronizado SinclonizaLex(List<CLexema>s1,List<CLexema>s2,int pos1, int pos2)
        {
