...
namespace SQLDeveloper.Modulos.Visores.Tabla
{
    public partial class FormTabla : Form
    {
        ...
        public event OnVerObjetoEvent OnVerCodigoTabla;
        public event OnVerObjetoEvent OnVerTablaPadre;
        public event OnVerObjetoEvent OnVerDependencias;
        public event OnVerObjetoEvent OnVerRelaciones;
        public event OnVerObjetoEvent OnVerTrrigers;
        ...
        {
            FormForeignKeys dlg = new FormForeignKeys(NombreTabla);
            dlg.ShowDialog();
            if(dlg.Modificado)
            {
        ...
        {
            FormIndexs dlg= new FormIndexs(this.NombreTabla);
            dlg.ShowDialog();
            if(dlg.Modificado)
            {
                MuestraDatos();
        ...
        {
            FormAgregarCampo dlg = new FormAgregarCampo(NombreTabla);
        ...
        {
            FormQuitarCampo dlg = new FormQuitarCampo(NombreTabla);
            if (dlg.ShowDialog() != DialogResult.OK)
                return;
            MuestraDatos();
        ...
        {
            FormUniques dlg = new FormUniques(NombreTabla);
            if (dlg.ShowDialog() != DialogResult.OK)
                return;
            MuestraDatos();
        }
        ...
        {
            FormChecks dlg = new FormChecks(NombreTabla);
            dlg.ShowDialog();
        }

        private void BEditarCampos_Click(object sender, EventArgs e)
        {
            FormEditarColumna dlg = new FormEditarColumna(NombreTabla);
            if (dlg.ShowDialog() != DialogResult.OK)
                return;
            MuestraDatos();
        }
        ...
        {
            FormDatosAvanzados dlg = new FormDatosAvanzados(NombreTabla);
            dlg.ShowDialog();
        }
