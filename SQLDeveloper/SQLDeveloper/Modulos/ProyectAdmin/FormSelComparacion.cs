...
namespace SQLDeveloper.Modulos.ProyectAdmin
{
    public partial class FormSelComparacion : Form
    {
        ...
        String Servidor;
        Conexiones.CConexion Conexion;
        String Nombre;
        MotorDB.EnumTipoObjeto Tipo;
        public FormSelComparacion(ModeloBasico modelo, string servidor, Conexiones.CConexion conexion, string nombre,MotorDB.EnumTipoObjeto tipo)
        {
            InitializeComponent();
            Text=nombre;
            Modelo = modelo;
