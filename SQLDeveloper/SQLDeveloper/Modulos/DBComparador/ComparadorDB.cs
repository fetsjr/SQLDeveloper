...
namespace SQLDeveloper.Modulos.DBComparador
{
    ...
    public partial class ComparadorDB : Form
    {
        ...
        Modulos.Buscador.CTipoBusqueda TipoBusqueda;
        ...
        private void CargaTipos()
        {
            ...
            ComboTipo.Items.Add(new Modulos.Buscador.CTipoBusqueda("Todos", MotorDB.EnumTipoObjeto.NONE));
            ComboTipo.Items.Add(new Modulos.Buscador.CTipoBusqueda("Tablas", MotorDB.EnumTipoObjeto.TABLE));
            ComboTipo.Items.Add(new Modulos.Buscador.CTipoBusqueda("Type Table", MotorDB.EnumTipoObjeto.TYPE_TABLE));
            ComboTipo.Items.Add(new Modulos.Buscador.CTipoBusqueda("Vistas", MotorDB.EnumTipoObjeto.VIEW));
            ComboTipo.Items.Add(new Modulos.Buscador.CTipoBusqueda("Procediientos almacenados", MotorDB.EnumTipoObjeto.PROCEDURE));
            ComboTipo.Items.Add(new Modulos.Buscador.CTipoBusqueda("Funciones", MotorDB.EnumTipoObjeto.FUNCION));
            ComboTipo.Items.Add(new Modulos.Buscador.CTipoBusqueda("Trigers", MotorDB.EnumTipoObjeto.TRIGER));
            ComboTipo.SelectedIndex = 0;

        }
        private void CargaGrupos()
        {
            List<string> l = Conexiones.ControladorConexiones.GetGrupos();
        ...
        private void ComboGrupo_IndexCahnge(object sender, EventArgs e)
        {
            ...
            List<Conexiones.CConexion> l = Conexiones.ControladorConexiones.GetConexiones(combo.SelectedItem.ToString());
            ComboConexion.Items.Clear();
            foreach (Conexiones.CConexion obj in l)
            {
        ...
        {
            Conexiones.CConexion obj = (Conexiones.CConexion)ComboConexion2.SelectedItem;
        ...
        {
            TipoBusqueda = (Modulos.Buscador.CTipoBusqueda)ComboTipo.SelectedItem;
        }
        ...
        private void dataGridView1_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dr["TipoDiferencia"].ToString() == "D")
            {
                ...
                {
                    Conexiones.CPropiedadesMotor propiedades = Conexiones.ControladorConexiones.DamePropiedadesMotor(DBProvider.DB);
