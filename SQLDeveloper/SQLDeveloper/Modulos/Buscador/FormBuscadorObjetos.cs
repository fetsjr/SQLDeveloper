...
namespace SQLDeveloper.Modulos.Buscador
{
    public partial class FormBuscadorObjetos : Form
    {
        ...
        private void Buscar()
        {
            ...
            if (!BKBuscar.IsBusy)
            {
                CTipoBusqueda obj = (CTipoBusqueda)ComboTipo.SelectedItem;
                tipo = obj.Tipo;
        ...
        {
            Objetos = DBProvider.DB.Buscar(cadena, tipo);
        }
        ...
        private void ListaObjetos_DoubleClick(object sender, EventArgs e)
        {
            ...
            if(OnVerObjeto!=null)
            {
                ...
                OnVerObjeto(DBProvider.DB, nodo.Nombre, nodo.Tipo);
            }
        }
        ...
        private void ListaObjetos_ItemDrag(object sender, ItemDragEventArgs e)
        {
            ...
            switch(nodo.Tipo)
            {
                case MotorDB.EnumTipoObjeto.PROCEDURE:
                    cadena = DBProvider.DB.GetExcecute_StoreProcedure(nodo.Nombre);
                    break;
                case MotorDB.EnumTipoObjeto.FUNCION:
                    cadena = DBProvider.DB.GetExcecute_Function(nodo.Nombre);
                    break;
                default:
                    cadena=nodo.Nombre;
                    break;
