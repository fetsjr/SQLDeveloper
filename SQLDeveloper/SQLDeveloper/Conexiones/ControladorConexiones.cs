...
namespace SQLDeveloper.Conexiones
{
    ...
    public class ControladorConexiones
    {
        ...
        public static EnumMotoresDB DameTipoMotor(string nombre)
        {
            ...
            if (nombre == EnumMotoresDB.ORACLE.ToString())
                motor = EnumMotoresDB.ORACLE;
        ...
        {
            MotorDB.EnumMotoresDB tipoDB = Conexiones.ControladorConexiones.DameTipoMotor(conexion.MotorDB);
